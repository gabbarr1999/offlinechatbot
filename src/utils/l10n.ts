...
export interface L10n {
  ...
  goToModels: string;
  readyToChat: string;
  pleaseLoadModel: string;
  shortMemoryWarning: string;
  ...
  hfModel: string;
  hfFABLabel: string;
  localFABLabel: string;
  resetFABLabel: string;
  downloaded: string;
  grouped: string;
  proceedWithReset: string;
  confirmReset: string;
  modelSettingsTitle: string;
  autoOffloadLoad: string;
  autoOffloadLoadDescription: string;
  metal: string;
  metalDescription: string;
  layersOnGPU: string;
  contextSize: string;
  contextSizePlaceholder: string;
  invalidContextSizeError: string;
  modelReloadNotice: string;
  autoNavigateToChat: string;
  autoNavigateToChatDescription: string;
  uiSettingsTitle: string;
  darkMode: string;
  darkModeDescription: string;
  displayMemoryUsage: string;
  displayMemoryUsageDescription: string;
  tooltipGroupByType: string;
  tooltipDownloaded: string;
  tooltipHf: string;
  unknownGroup: string;
  menuTitleHf: string;
  menuTitleDownloaded: string;
  menuTitleGrouped: string;
  menuTitleReset: string;
  downloadModelTitle: string;
  downloadModelDescription: string;
  downloadModelTimeEstimate: string;
  deleteChatsTitle: string;
  deleteChatsConfirm: string;
  settings: string;
}
...
export const l10n = {
  en: {
    ...
    downloadModelTitle: "Are you ready?",
    downloadModelDescription: "Let's download Llama 3.2 1B model to chat with AI.",
    downloadModelTimeEstimate: "*It'll take around 5 min to download with 100m bps internet.",
    deleteChatsTitle: "Delete chats?",
    deleteChatsConfirm: "Are you sure to delete all the historical chats?",
    settings: "Settings"
  },
  es: {
    ...
    downloadModelTitle: "¿Estás listo?",
    downloadModelDescription: "Vamos a descargar el modelo Llama 3.2 1B para chatear con IA.",
    downloadModelTimeEstimate: "*Tardará aproximadamente 5 minutos en descargar con una conexión de 100m bps.",
    deleteChatsTitle: "¿Borrar chats?",
    deleteChatsConfirm: "¿Estás seguro de borrar todos los chats históricos?",
  ...
  ko: {
    ...
    memoryWarning:
      '경고: 모델 크기가 또는 장치의 총 메모리를 초과합니다 ({{totalMemory}}). 이는 속도가 느려지거나 시스템 불안정성을 일으킬 수 있는 예기치 않은 동을 일으켜 초래할 수 있습니다.',
    load: '로드',
    cancel: '취소',
    download: '다운로드',
    offload: '해제',
  ...
  pt: {
    ...
    modelReloadNotice:
      'Należy ponownie załadować model, aby zmiany zaczęły obowiązywać.',
    autoNavigateToChat: 'Automatycznie przejdź do conversa',
    autoNavigateToChatDescription:
      'Przejdź do conversa, quando começar a carregar.',
    uiSettingsTitle: 'Configurações da Interface do Usuário',
    darkMode: 'Modo Escuro',
    darkModeDescription: 'Ligar ou desligar o modo escuro.',
    displayMemoryUsage: 'Exibir Uso de Memória',
    displayMemoryUsageDescription: 'Exibir uso de memória na página de chat.',
    tooltipGroupByType: 'Agrupar por tipo de modelo',
    tooltipDownloaded: 'Exibir apenas baixados',
    tooltipHf: 'Exibir modelos provenientes de Hugging Face',
  ...
  ru: {
    attachmentButtonAccessibilityLabel: 'Отпрвить медиа',
